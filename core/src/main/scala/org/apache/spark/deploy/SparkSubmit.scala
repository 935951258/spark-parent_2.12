...
private[spark] class SparkSubmit extends Logging {
   ...
   /___/ .__/\_,_/_/ /_/\_\   version %s
    ...
    private def runMain(args: SparkSubmitArguments, uninitLog: Boolean): Unit = {
        // 准备提交环境  重点是: childMainClass ->
        // yarn-cluster 模式:childMainClass =  org.apache.spark.deploy.yarn.YarnClusterApplication
        ...
        val loader: MutableURLClassLoader = getSubmitClassLoader(sparkConf)
        ...
        // 在 yarn-cluster 模式下: mainClass = org.apache.spark.deploy.yarn.YarnClusterApplication
...
object SparkSubmit extends CommandLineUtils with Logging {
    ...
    override def main(args: Array[String]): Unit = {
        val submit: SparkSubmit = new SparkSubmit() {
            self =>

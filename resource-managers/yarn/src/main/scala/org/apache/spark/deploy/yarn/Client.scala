...
private[spark] class Client(
    ...
    private val launcherBackend: LauncherBackend = new LauncherBackend() {
    ...
    def submitApplication(): ApplicationId = {
        ...
        try {
            ...
            // 从 RM 得到一个新的应用
            val newApp: YarnClientApplication = yarnClient.createApplication()
    ...
    : ContainerLaunchContext = {
        ...
        // 确定 AM 类
        //cluster 模式: org.apache.spark.deploy.yarn.ApplicationMaster
        // client 模式: org.apache.spark.deploy.yarn.ExecutorLauncher
        val amClass =
            if (isClusterMode) {
